...
export declare class SubmissionsController {
    ...
    submitPhase(req: any, phaseId: string, dto: CreateSubmissionDto): Promise<{
        id: string;
        updatedAt: Date;
        content: string;
    ...
    getPhaseSubmissions(req: any, phaseId: string): Promise<({
        reviews: ({
            reviewer: {
                name: string;
    ...
    review(req: any, id: string, dto: CreateReviewDto): Promise<({
        studentProjectPhase: {
            id: string;
            status: import(".prisma/client").$Enums.PhaseStatus;
        };
